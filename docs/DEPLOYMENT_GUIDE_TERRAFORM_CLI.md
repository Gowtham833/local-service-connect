# ServiConnect — Terraform CLI Deployment Guide
# Fast, Automated Infrastructure as Code Deployment

This guide explains how to deploy the entire ServiConnect AWS architecture automatically using Terraform via your local computer's terminal.
